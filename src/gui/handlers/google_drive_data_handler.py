...
class GoogleDriveDataHandler:
    ...
    def __init__(self, settings_handler):
        ...
        self.folder_id = None
        self.runs_folder_id = "1u1Ea9aRu3B405BmpaDJgads1BrLrCp4P"  # Direct ID of the runs folder
    ...
    def upload_run_folder(self, run_id):
        """
        Upload a specific run folder to Google Drive.
        
        Args:
            run_id: ID of the run folder to upload
        ...
        try:
            ...
            # Use the direct runs folder ID instead of searching
            runs_folder_id = self.runs_folder_id
            logger.info(f"Using runs folder ID: {runs_folder_id}")
            ...
            # Upload each file in the run folder
            ...
            logger.info(f"Successfully uploaded run folder: {run_id}")
            return True
