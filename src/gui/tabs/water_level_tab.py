...
from PyQt5.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QGridLayout,
                           ...
                           QTableWidgetItem, QMessageBox, QComboBox, QDialog, QFileDialog, QApplication, QDateTimeEdit, QDoubleSpinBox, QLineEdit, QTextEdit, QDialogButtonBox, QCheckBox, QHeaderView, QProgressBar)
...
class WaterLevelTab(QWidget):
    ...
    def setup_ui(self):
        ...
        plot_controls.setSpacing(5)  # Reduced spacing
    ...
    def on_cell_clicked(self, row, col):
        ...
        if col == 0:  # User flag column
            ...
            if item:
                ...
                self.update_user_flag(well_number, new_status)
    ...
    def update_user_flag(self, well_number, status):
    ...
    def setup_wells_table(self):
        ...
        # Style settings with smaller font for headers
